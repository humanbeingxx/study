...
public class TrulyMostPopularTest {

    @Test
    public void testTrulyMostPopular1() {
        String[] result = new TrulyMostPopular().trulyMostPopular(
    ...
    @Test
    public void testTrulyMostPopular2() {
        String[] result = new TrulyMostPopular().trulyMostPopular(
