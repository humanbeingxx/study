...
public class SimpleHystrixTest {
    ...
    public void testCreateSimpleCommand() throws Exception {
        HystrixCommand<String> testSimpleCommand = SimpleHystrix.createSimpleCommand("testSimpleCommand");
        String result = testSimpleCommand.execute();
        System.out.println(result);
    }

    @Test
    public void testCreateSimpleCommandWithAsyncExecution() throws InterruptedException, ExecutionException, TimeoutException {
        HystrixCommand<String> testSimpleCommand = SimpleHystrix.createSimpleCommand("testSimpleCommand");
    ...
    public void testCreateSimpleObservableCommandWithFuture() throws Exception {
        HystrixObservableCommand<String> testSimpleCommandObservable
                = SimpleHystrix.createSimpleObservableCommand("testSimpleCommandObservable");
        BlockingObservable<String> blocking = testSimpleCommandObservable.observe().toBlocking();
    ...
    public void testCreateSingleObservableCommandWithFuture() throws Exception {
        HystrixObservableCommand<String> testSimpleCommandObservable
                = SimpleHystrix.createSingleObservableCommand("testSingleCommandObservable");
        BlockingObservable<String> blocking = testSimpleCommandObservable.observe().toBlocking();
        Future<String> future = blocking.toFuture();
        String result = future.get();
        System.out.println(result);
    ...
    public void testHotObservable() throws InterruptedException {
        HystrixObservableCommand<String> observableCommand
                = SimpleHystrix.createSimpleObservableCommand("testSimpleCommandObservable");
        ...
        observe.subscribe(new Observer<String>() {
            @Override
            public void onCompleted() {
                System.out.println("observer completed @ " + System.currentTimeMillis());
            }

            @Override
            public void onError(Throwable e) {
                System.out.println("observer error @ " + System.currentTimeMillis());
            }

            @Override
            public void onNext(String s) {
                System.out.println("observer @ " + System.currentTimeMillis() + " onNext with " + s);
            }
        });
    }
    ...
    public void testCreateSimpleFallBack() throws Exception {
        HystrixCommand<String> hystrixCommand = SimpleHystrix.createSimpleFallBack("testCreateSimpleFallBack");
    ...
    public void testCreateSimpleObservableFallBack() throws Exception {
        HystrixObservableCommand<String> testCreateSimpleObservableFallBack
                = SimpleHystrix.createSimpleObservableFallBack("testCreateSimpleObservableFallBack");
        Observable<String> observe = testCreateSimpleObservableFallBack.observe();
        observe.subscribe(new Observer<String>() {
            @Override
            public void onCompleted() {
                System.out.println("observer completed");
